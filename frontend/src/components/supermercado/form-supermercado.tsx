				...
				<div className="flex flex-1 gap-4">
					<div className="flex flex-1 flex-col">
						...
						<input
							...
							onChange={(e) =>
								alteraSupermercado({ ...supermercado, razaoSocial: e.target.value })
							}
				...
				<div className="flex flex-1 gap-4">
					...
					<div className="flex flex-1 flex-col">
						...
						<input
							...
							onChange={(e) =>
								alteraSupermercado({ ...supermercado, usuarioId: e.target.value })
							}
							value={supermercado.usuarioId ?? ""}
						/>
					</div>
				</div>
				<div className="flex flex-1 gap-4">
					<div className="flex flex-1 flex-col">
						...
						<select
							...
							onChange={(e) =>
								alteraSupermercado({
									...supermercado,
									status: e.target.value as "Ativo" | "Bloqueado" | "Cancelado",
								})
							}
						>
